    ...
    <main class="main-content w-full pb-8">
                    ...
                    <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                        ...
                        <div class="grow">
                            <div class="flex w-full space-x-1">
                                <div x-tooltip="'Phone Calls'" class="h-2 w-1/2 rounded-full bg-primary dark:bg-accent"></div>
                            ...
                            <div class="mt-2 flex flex-wrap">
                                ...
                                <div class="mr-4 mb-1 inline-flex items-center space-x-2 font-inter">
                                    ...
                                    <div class="flex space-x-1 text-xs">
                                        <span> {{ $item->maximum_price > 5000000 ? 'infinite' : number_format($item->maximum_price) }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <a class="btn mt-3 w-full border border-white/10 bg-white/20 text-white hover:bg-white/30 focus:bg-white/30">
                            Invest
                        </a>
                    </div>
                @endforeach
        ...
        <div class="mt-4 grid grid-cols-12 gap-4 bg-slate-150 py-5 dark:bg-navy-800 sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6">
            <div class="col-span-12 flex flex-col px-[var(--margin-x)] transition-all duration-[.25s] lg:col-span-3 lg:pr-0">
                ...
                <p class="mt-3 grow">
                    This gives you flexible payment plan, flexible plans give you more control over how much money you spend on them over a short period of time with low risk and low reward.
                </p>
            ...
            <div class="is-scrollbar-hidden col-span-12 flex space-x-4 overflow-x-auto px-[var(--margin-x)] transition-all duration-[.25s] lg:col-span-9 lg:pl-0">
                @foreach ($flexibleInvestment as $item)
                    <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
                        ...
                        <a href="" class="btn mt-3 w-full border border-white/10 bg-white/20 text-white hover:bg-white/30 focus:bg-white/30">
                            Invest
                        </a>
                    </div>
                @endforeach
