                                        ...
                                        <div class="w-full max-w-md text-center py-6">
                                            <div class="text-primary-500 mx-auto w-14 h-14 mb-4">
                                                <svg class="relative block w-14 h-14 rounded-full stroke-2 stroke-current animate-scale"
                                                    ...
                                                    <circle class="stroke-2 stroke-current animate-circle" cx="26"
                                                        cy="26" r="25" fill="none" stroke-dasharray="166"
                                                        stroke-dashoffset="166" stroke-miterlimit="10"></circle>
                                            ...
                                            <h2 class="font-heading font-bold text-2xl mb-2 text-muted-800 dark:text-white">
