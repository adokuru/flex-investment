                    ...
                    <div class="w-full grid md:grid-cols-12 gap-10">
                        ...
                        <div class="md:col-span-9 lg:col-span-8">
                            ...
                            <div class="relative max-w-md space-y-3">
                                <form class="w-full space-y-4" action="{{ route('withdrawal.withdrawalAdd') }}"
                                    method="post">
                                    @csrf
                                    <div class="w-full">
                                        ...
                                        <div>
                                            <h2
                                                ...
                                                Review and withdraw
                                                {{ $amount / $wallet->walletType->value }}
                                                    ...
                                                    <div class="w-full flex gap-6 py-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <p
                                                                ...
                                                                <span>
                                                                    Recieve {{ $wallet->walletType->name }} to this address
                                                                </span>
                                                            </p>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="w-full flex items-center gap-3 text-left">
                                                            <div>
                                                                ...
                                                                <span
                                                                    ...
                                                                    ${{ $wallet->usd_balance }} / {{ $wallet->amount }}
                                                                    {{ $wallet->walletType->symbol }}
                                                                </span>
                                                            </div>
