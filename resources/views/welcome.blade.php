...
@section('content')
    <main>
                ...
                <ul class="uk-slideshow-items uk-light">
                    <li>
                        <div class="uk-position-cover">
                            <img src="/img/in-lazy.gif" data-src="/img/in-slideshow-image-4.jpeg" alt="slideshow-image"
                    ...
                    <li>
                        <div class="uk-position-cover">
                            <img src="/img/in-lazy.gif" data-src="/img/in-slideshow-image-2.jpeg" alt="slideshow-image"
                                data-uk-cover width="1920" height="700" data-uk-img>
                        </div>
                        <span></span>
                        <div class="uk-container">
                    ...
                    <li>
                        <div class="uk-position-cover">
                            <img src="/img/in-lazy.gif" data-src="/img/in-slideshow-image-3.jpeg" alt="slideshow-image"
                                data-uk-cover width="1920" height="700" data-uk-img>
                        </div>
                        <span></span>
                        <div class="uk-container">
            ...
            <div class="uk-container in-wave-1">
                <div class="uk-grid uk-grid-divider uk-child-width-1-2@s uk-child-width-1-4@m in-margin-top@s in-margin-bottom@s"
                    ...
                    <div>
                        <div class="uk-grid uk-grid-small uk-flex uk-flex-middle">
                            <div class="uk-width-auto">
                                <img src="/img/in-lazy.gif" data-src="/img/in-wave-icon-1.svg" alt="wave-icon"
                    ...
                    <div>
                        <div class="uk-grid uk-grid-small uk-flex uk-flex-middle">
                            <div class="uk-width-auto">
                                <img src="/img/in-lazy.gif" data-src="/img/in-wave-icon-2.svg" alt="wave-icon"
                                    width="48" height="48" data-uk-img>
                            </div>
                            <div class="uk-width-expand">
                    ...
                    <div>
                        <div class="uk-grid uk-grid-small uk-flex uk-flex-middle">
                            <div class="uk-width-auto">
                                <img src="/img/in-lazy.gif" data-src="/img/in-wave-icon-3.svg" alt="wave-icon"
                                    width="48" height="48" data-uk-img>
                            </div>
                            <div class="uk-width-expand">
                    ...
                    <div>
                        <div class="uk-grid uk-grid-small uk-flex uk-flex-middle">
                            <div class="uk-width-auto">
                                <img src="/img/in-lazy.gif" data-src="/img/in-wave-icon-4.svg" alt="wave-icon"
                                    width="48" height="48" data-uk-img>
                            </div>
                            <div class="uk-width-expand">
        ...
        <div class="uk-section uk-section-muted uk-padding-large in-wave-3 uk-background-contain uk-background-center"
            style="background-image: url(img/in-wave-background-1.png); background-color:white;"
            data-uk-parallax="bgy: -200">
            <div class="uk-container">
                <div class="uk-grid-large uk-flex uk-flex-middle" data-uk-grid>
                    <div class="uk-width-1-2@m">
                        <img class="uk-margin-bottom" src="/img/in-lazy.gif" data-src="/img/in-wave-icon-5.svg"
        ...
        <!-- section content end -->
        <div class="uk-section uk-section-default in-wave-15 in-offset-bottom-40 uk-background-contain uk-background-center-right uk-background-image@m"
            style="background-image: url(img/in-wave-background-3.png);">
            <div class="uk-container">
                <div class="uk-grid uk-flex uk-flex-middle">
                    <div class="uk-width-1-3@m">
                        ...
                        <form class="uk-grid-small uk-grid uk-grid-stack" data-uk-grid="">
                            <div class="uk-width-1-1 uk-width-auto@m uk-grid-margin uk-first-column">
                                <a href='/register'
                                    class="uk-button uk-button-secondary uk-border-rounded uk-width-expand">Sign up</a>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="uk-width-auto@m uk-visible@m">
                        <a class="uk-flex uk-flex-middle uk-light in-wave-15-button" href="#">
                            <h3>Get a taste of the<br>Wave experience</h3>
            ...
            <div class="in-price-list">
                <div class="uk-container">
                    <div class="uk-grid">
                        ...
                        <div id="coinmarketcap-widget-marquee" coins="1,1027,825,5426,3408,328" currency="USD"
